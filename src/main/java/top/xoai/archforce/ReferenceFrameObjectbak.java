...
//        this.queryMapper = queryMapper;
//        this.dbBaseIndexIndicator = dbBaseIndexIndicator;
//    }
//
//    public void initBaseIndicator(Map<String,Long> indicator, QueryMapperImpl queryMapper){
//        this.dbBaseIndexIndicator = indicator;
//        this.queryMapper = queryMapper;
//    }
//
...
//            CountObject countObject = queryMapper.countChunk(oldLastDataBaseIndex, dbBaseIndex);
...
//        logger.info("dbBaseIndex:" + getDbBaseIndex());
//        logger.info("dbBaseIndexIndicator:" + getDbBaseIndexIndicator());
//        boolean isFirstBase = (getDbBaseIndex() == 0);
//        CountObject countResult = queryMapper.countIncrease(getDbBaseIndex());
//        updateCurrentDBIndex(countResult.getIncreasedCount());
//        logger.info("dbBaseIndexOffset:" + getBaseIndexOffset());
//        logger.info("dbBaseIndexOffsetIndicator:" + countResult.getStatisticalData());
//        final Map<String,Long> indicatorResult = new HashMap<>(getDbBaseIndexIndicator());
//        countResult.getStatisticalData().forEach((key,value)-> indicatorResult.merge(key,value, Long::sum));
//        logger.info("currentDBIndex:" + getDbCurrentIndex());
